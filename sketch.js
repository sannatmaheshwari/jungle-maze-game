...
bullet1Img = loadAnimation("images/bullet1.png")
bulletImg = loadAnimation("images/bullets.png")
tressureimg = loadImage("images/tressure.png")
...
function setup() {
 ...
 tressure1 = createSprite(1030,660,20,20)
 tressure1.addImage(tressureimg)
 tressure1.scale = 0.35
 tressure2 = createSprite(1310,330,20,20)
 tressure2.addImage(tressureimg)
 tressure2.scale = 0.35
...
log30 = createSprite(480,650,20,100)
log30.shapeColor = ("yellow")
...
drop4 = createSprite(500,450,20,20)
...
spider1.scale = 0.3
spider1.setCollider("rectangle",0,20,100,280)
spider1.velocityX = 2;
spider1.velocityY = 2;
spider1.setCollider("circle",0,20,70)
...
spider2.velocityY = 2;
spider2.debug=false
spider2.setCollider("circle",0,20,70)

spider3 = createSprite(900,80,20,20)
spider3.addImage(spider)
spider3.scale = 0.3
spider3.velocityX = 2;
spider3.velocityY = 2;
spider3.setCollider("circle",0,20,70)
...
spider4.velocityX = 2;
spider4.velocityY = 2;
spider4.setCollider("circle",0,20,70)
...
spider5.velocityX = 2;
spider5.velocityY = 2;
spider5.setCollider("circle",0,20,70)
...
if(hunter.isTouching(tressure1)){
  tressure1.destroy()
  scores+=50
}

if(hunter.isTouching(tressure2)){
  tressure2.destroy()
  scores+=70
}
 ...
 if(hunter.isTouching(log30)&&scores === 170){
   gameState = 3
 }
if(lives === -1){
  gameState = 4
